    ...
    >
      <View style={styles.header}>
        ...
        <Text style={[type.body, styles.subtitle]}>
          Soon, places pulled from the cities you've dreamt of and the ones you've
          already saved. A small, well-read friend with a pen in hand.
        </Text>
      ...
      <View style={styles.block}>
        ...
        <Text style={[type.body, { fontSize: 16, lineHeight: 26, color: colors.text }]}>
          The suggestions engine is on the shelf — we'll wire it up once the LLM side
          settles down. Until then, keep adding places, and this page will learn your
          taste when it returns.
        </Text>
      </View>
